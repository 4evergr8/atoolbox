        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: const Text('4evergr8'),
              onTap: () {
                launchUrl(Uri.parse('https://github.com/4evergr8'), mode: LaunchMode.externalApplication);
            ...
            ListTile(
              ...
              onTap: () {
                launchUrl(Uri.parse('https://4evergr8.github.io'), mode: LaunchMode.externalApplication);
              },
            ),
